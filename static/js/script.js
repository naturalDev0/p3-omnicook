...
$(document).ready(function() {
    ...
    $('.add-row').click(function(e) {
        ...
        var newRow = '<div class="form-row justify-content-center" id="' + addRowId + '">' +
            ...
            '<input type="text" class="form-control" name="ingred-name-' + nextNo + '" id="ingred-name-' + nextNo + '" placeholder="insert your ingredient...">' +
            '</div>' +
            '<div class="form-group col-md-5">' +
            '<input type="text" class="form-control" name="ingred-serve-' + nextNo + '" id="ingred-serve-' + nextNo + '" placeholder="insert your ingredient serving...">' +
            '</div>' +
